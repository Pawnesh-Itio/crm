        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="chat-screen"
					...
					<div class="button">
						<div class="message-input">
	                        <input type="hidden" id="chatId" class="chatId" name="chatId"/>
...
function getTelegramChat(name,chatId,token='')
{
	//console.log(token);
	$('.modal-title').html(name+' ('+ chatId +')');
	//$('#chatId').val(chatId);
	//$('#message-container').html('');// Remove any exisiting listener before adding 
}
</script>
</body>
