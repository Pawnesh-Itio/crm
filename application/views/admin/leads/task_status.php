...
<div id="wrapper">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="tw-mb-2 sm:tw-mb-4"> <a href="#" onclick="new_status(); return false;" class="btn btn-primary"> <i class="fa-regular fa-plus tw-mr-1"></i> <?php echo _l('New Deal Task Status'); ?> </a> </div>
        <div class="panel_s">
          <div class="panel-body panel-table-full">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-3">
                                            ...
                                            <a href="<?php echo admin_url('leads/delete_task_status/' . $status['id']); ?>"
            ...
            <?php } else { ?>
            <p class="no-margin"><?php echo _l('Task Not Found'); ?></p>
            <?php } ?>
          </div>
        </div>
      </div>
...
<div class="modal fade" id="status" tabindex="-1" role="dialog">
  <div class="modal-dialog"> <?php echo form_open(admin_url('leads/taskstatus'), ['id' => 'task-status-form']); ?>
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"> <span class="edit-title"><?php echo _l('edit_status'); ?></span> <span class="add-title"><?php echo _l('Add New Task Status'); ?></span> </h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
			...
			<?php echo render_input('statusorder', 'leads_status_add_edit_order', total_rows(db_prefix() . 'task_status') + 1, 'number'); ?></div>
        </div>
      </div>
