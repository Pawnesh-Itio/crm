...
<div class="<?php if ($openEdit == true) {
	...
	<div class="mleft5 pull-right">
        <a href="#" class="btn btn-success pull-right lead-top-btn" ><i class="fa-solid fa-handshake"></i> Deal <?php echo $lead->is_deal?></a>
    </div>
	<?php }else{ ?>
	<div class="mleft5 pull-right">
...
<?php echo form_close(); ?>
				...
				<div role="tabpanel" class="tab-pane" id="lead_notes">
					<?php echo form_open(admin_url('leads/add_task/' . $lead->id), ['id' => 'lead-task']); ?>
